...
def draw_points_on_circle(window, circle, number_of_points, color):
    ...
    for k in range(len(points)):
        new_circle = rg.Circle(points[k], 10)
...
def run_test_polygon():
    ...
    # -------------------------------------------------------------------------
    # Tests 3:
    title = ('POLYGON tests 3:  10 segments with thick black lines')
    window = rg.RoseWindow(550, 400, title)
...
def run_test_fancy_polygon():
    ...
    title = ('FANCY POLYGON test 4:  20 blue lines on lime green circle')
    window = rg.RoseWindow(480, 350, title)
    ...
    title = ('FANCY POLYGON test 5:  51 red lines on white circle')
    window = rg.RoseWindow(480, 350, title)
    ...
    title = ('FANCY POLYGON test 6:  300 black lines on yellow circle')
    window = rg.RoseWindow(480, 350, title)
